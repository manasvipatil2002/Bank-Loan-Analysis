...
## <div style="display:flex;align-items:center;font-family:Arial,sans-serif;font-size:50px;"><img src="image/bank.jpeg" alt="Bank Icon" style="height:80px;margin-right:10px;"><span>Bank Loan Report</span></div>
