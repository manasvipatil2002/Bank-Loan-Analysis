...
## <div style="display:flex;align-items:center;font-family:Arial,sans-serif;"><img src="image/bank.jpeg" alt="Bank Icon" style="height:70px;margin-right:10px;"><span style="font-size:2000px;">Bank Loan Report</span></div>
