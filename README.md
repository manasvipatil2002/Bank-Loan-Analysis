...
<div style="display:flex;align-items:center;font-family:Arial,sans-serif;"><img src="bank-icon.png" alt="Bank Icon" style="height:40px;margin-right:10px;"><span style="font-size:36px;">Bank Loan Report</span></div>
